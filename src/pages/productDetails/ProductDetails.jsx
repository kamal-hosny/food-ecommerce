  ...
  return (
    <>
      ...
      <main className="productDetails">
        <BreadCrumbs />
        <HeadLines title={productDetails?.data?.attributes?.name} subtitle={""} />
        <div className="productDetails--container">
          <div className="productDetails--image">
            ...
            <img src={apiUrl + productDetails?.data?.attributes?.image?.data[0]?.attributes?.url} alt={productDetails?.data?.attributes?.slug} />
          </div>
          <div className="productDetails--content">
            <h4>{productDetails?.data?.attributes?.name}</h4>
            <p>{productDetails?.data?.attributes?.description}</p>
            <span>
              {productDetails?.data?.attributes?.price} EG
            </span>
